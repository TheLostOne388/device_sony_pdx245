...
# 
# # Ensure this override is triggered for the actual dtbo image target
# $(INSTALLED_DTBOIMAGE_TARGET): dtboimage
# 
# # --- Override for vendor_boot.img (as per AVB_Conflict_Summary.txt) ---
# .PHONY: vendorbootimage vendor_boot_override_prereq
# 
# vendor_boot_override_prereq:
# 	@echo "Vendor boot override prerequisite met"
# 
# vendorbootimage: vendor_boot_override_prereq
...
# 
# # Try to ensure our phony target is triggered when the system considers vendor_boot.img
# $(INSTALLED_VENDOR_BOOTIMAGE_TARGET): vendorbootimage
